...
use libc::{FILE, c_char, c_int, c_uint, c_void, iovec, nlmsghdr};
...
pub const __NFTNL_EXPR_PAYLOAD_MAX: u32 = 9;
...
pub const __NFTNL_EXPR_RANGE_MAX: u32 = 5;
...
pub const __NFTNL_EXPR_NAT_MAX: u32 = 8;
...
pub const __NFTNL_EXPR_TPROXY_MAX: u32 = 4;
...
pub const __NFTNL_EXPR_LOOKUP_MAX: u32 = 6;
...
pub const __NFTNL_EXPR_DYNSET_MAX: u32 = 10;
...
pub const __NFTNL_EXPR_LOG_MAX: u32 = 7;
...
pub const __NFTNL_EXPR_EXTHDR_MAX: u32 = 8;
...
pub const __NFTNL_EXPR_CT_MAX: u32 = 5;
...
pub const __NFTNL_EXPR_BYTEORDER_MAX: u32 = 6;
...
pub const __NFTNL_EXPR_LIMIT_MAX: u32 = 6;

pub const NFTNL_EXPR_REJECT_TYPE: u32 = 1;
pub const NFTNL_EXPR_REJECT_CODE: u32 = 2;
pub const __NFTNL_EXPR_REJECT_MAX: u32 = 3;
...
pub const __NFTNL_EXPR_MASQ_MAX: u32 = 4;
...
pub const __NFTNL_EXPR_XFRM_MAX: u32 = 6;
...
pub const __NFTNL_EXPR_SYNPROXY_MAX: u32 = 4;

pub const NFTNL_EXPR_LAST_MSECS: u32 = 1;
pub const NFTNL_EXPR_LAST_SET: u32 = 2;
pub const __NFTNL_EXPR_LAST_MAX: u32 = 3;
...
pub const __NFTNL_EXPR_INNER_MAX: u32 = 5;
...
unsafe extern "C" {
    pub fn nftnl_gen_is_set(gen_: *const nftnl_gen, attr: u16) -> bool;
}
unsafe extern "C" {
    pub fn nftnl_gen_unset(gen_: *mut nftnl_gen, attr: u16);
}
unsafe extern "C" {
    pub fn nftnl_gen_set(gen_: *mut nftnl_gen, attr: u16, data: *const c_void) -> c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn nftnl_gen_get(gen_: *const nftnl_gen, attr: u16) -> *const c_void;
}
unsafe extern "C" {
    pub fn nftnl_gen_get_data(
        gen_: *const nftnl_gen,
        attr: u16,
        data_len: *mut u32,
    ) -> *const c_void;
}
unsafe extern "C" {
    pub fn nftnl_gen_set_u32(gen_: *mut nftnl_gen, attr: u16, data: u32);
}
unsafe extern "C" {
    pub fn nftnl_gen_get_u32(gen_: *const nftnl_gen, attr: u16) -> u32;
}
unsafe extern "C" {
    pub fn nftnl_gen_nlmsg_parse(nlh: *const nlmsghdr, gen_: *mut nftnl_gen) -> c_int;
}
unsafe extern "C" {
...
pub const __NFTNL_OBJ_CT_HELPER_MAX: u32 = 19;
...
pub const __NFTNL_OBJ_CT_TIMEOUT_MAX: u32 = 19;
...
pub const __NFTNL_OBJ_CT_EXPECT_MAX: u32 = 21;
...
pub const __NFTNL_OBJ_LIMIT_MAX: u32 = 21;
...
pub const __NFTNL_OBJ_SYNPROXY_MAX: u32 = 19;
...
pub const __NFTNL_OBJ_TUNNEL_MAX: u32 = 32;

pub const NFTNL_OBJ_SECMARK_CTX: u32 = 16;
pub const __NFTNL_OBJ_SECMARK_MAX: u32 = 17;
...
unsafe extern "C" {
    pub fn nftnl_obj_set_u8(ne: *mut nftnl_obj, attr: u16, val: u8) -> c_int;
}
unsafe extern "C" {
    pub fn nftnl_obj_set_u16(ne: *mut nftnl_obj, attr: u16, val: u16) -> c_int;
}
unsafe extern "C" {
    pub fn nftnl_obj_set_u32(ne: *mut nftnl_obj, attr: u16, val: u32) -> c_int;
}
unsafe extern "C" {
    pub fn nftnl_obj_set_u64(obj: *mut nftnl_obj, attr: u16, val: u64) -> c_int;
}
unsafe extern "C" {
    pub fn nftnl_obj_set_str(ne: *mut nftnl_obj, attr: u16, str_: *const c_char) -> c_int;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_data(ne: *const nftnl_obj, attr: u16, data_len: *mut u32)
    -> *const c_void;
}
unsafe extern "C" {
    pub fn nftnl_obj_get(ne: *const nftnl_obj, attr: u16) -> *const c_void;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_u8(ne: *const nftnl_obj, attr: u16) -> u8;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_u16(obj: *const nftnl_obj, attr: u16) -> u16;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_u32(ne: *const nftnl_obj, attr: u16) -> u32;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_u64(obj: *const nftnl_obj, attr: u16) -> u64;
}
unsafe extern "C" {
    pub fn nftnl_obj_get_str(ne: *const nftnl_obj, attr: u16) -> *const c_char;
}
unsafe extern "C" {
...
pub const NFTNL_SET_COUNT: nftnl_set_attr = 19;
pub const __NFTNL_SET_MAX: nftnl_set_attr = 20;
...
pub const NFTNL_TRACE_CT_DIRECTION: nftnl_trace_attr = 18;
pub const NFTNL_TRACE_CT_ID: nftnl_trace_attr = 19;
pub const NFTNL_TRACE_CT_STATE: nftnl_trace_attr = 20;
pub const NFTNL_TRACE_CT_STATUS: nftnl_trace_attr = 21;
pub const __NFTNL_TRACE_MAX: nftnl_trace_attr = 22;
